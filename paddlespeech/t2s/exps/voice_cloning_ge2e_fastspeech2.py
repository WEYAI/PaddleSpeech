...
def voice_cloning(args):
    ...
    speaker_encoder.set_state_dict(paddle.load(ge2e_params_path))
    ...
    with paddle.no_grad():
        am_res = am_inference(phone_ids, spk_emb=spk_emb)
        wav = voc_inference(am_res)
